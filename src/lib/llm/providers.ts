...
export const PROVIDER_MODELS: Record<Provider, ModelInfo[]> = {
  ...
  OPENAI: [
    { id: "gpt-5.2-2025-12-11", displayName: "GPT-5.2", provider: "OPENAI" },
    { id: "gpt-5-mini-2025-08-07", displayName: "GPT-5 Mini", provider: "OPENAI" },
    { id: "gpt-4.1-2025-04-14", displayName: "GPT-4.1", provider: "OPENAI" },
    { id: "gpt-4.1-mini-2025-04-14", displayName: "GPT-4.1 Mini", provider: "OPENAI" },
    { id: "gpt-4o", displayName: "GPT-4o", provider: "OPENAI" },
    { id: "gpt-4o-mini", displayName: "GPT-4o Mini", provider: "OPENAI" },
    { id: "o3-2025-04-16", displayName: "o3", provider: "OPENAI" },
    { id: "o4-mini-2025-04-16", displayName: "o4-mini", provider: "OPENAI" },
    { id: "o3-mini-2025-01-31", displayName: "o3-mini", provider: "OPENAI" },
  ],
  GOOGLE: [
